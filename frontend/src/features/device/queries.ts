...
const SelfInfoSchema = z.looseObject({
  ...
  adv_loc_policy: z.number().optional(),
  multi_acks: z.number().optional(),
  telemetry_mode_base: z.number().optional(),
  telemetry_mode_loc: z.number().optional(),
  telemetry_mode_env: z.number().optional(),
  manual_add_contacts: z.boolean().optional(),
